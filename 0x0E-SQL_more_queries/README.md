...
9. Cities by States =  a script that lists all cities contained in the database hbtn_0d_usa.
    ...
    The database name will be passed as an argument of the mysql command
10. Genre ID by show = Import the database dump from hbtn_0d_tvshows to your MySQL server: "https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/274/hbtn_0d_tvshows.sql"
